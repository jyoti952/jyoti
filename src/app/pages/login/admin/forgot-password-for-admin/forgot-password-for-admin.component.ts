...
@Component({
  selector: 'app-forgot-password-for-admin',
  templateUrl: './forgot-password-for-admin.component.html',
  styleUrls: ['./forgot-password-for-admin.component.scss']
})
export class ForgotPasswordForAdminComponent implements OnInit {
